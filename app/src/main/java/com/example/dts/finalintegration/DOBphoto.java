...
public class DOBphoto extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dobphoto);
        ...
        btnselectpic = (Button)findViewById(R.id.button_selectpic);  login = this.getSharedPreferences("Login_sp",MODE_PRIVATE);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.uploadButton:
                ...
                prefsEditor.putString("DOBPhoto",encodedImage);
                prefsEditor.commit();go1=1;
                break;
            case R.id.next :
                if (go==1){
                    if (go1==1) {
                        startActivity(new Intent(getBaseContext(), Fatherphoto.class));
                    }
    ...
    public void showSimpleDialog1() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(DOBphoto.this);
