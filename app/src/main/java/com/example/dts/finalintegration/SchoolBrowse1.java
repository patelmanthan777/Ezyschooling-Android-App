...
public class SchoolBrowse1 extends AppCompatActivity {
    private ProgressDialog pDialog;
    ListViewAdapter adapter,adp1;int nofilter =0;
    ListView listview; private static final int STORAGE_PERMISSION_CODE = 123;
    private int PICK_IMAGE_REQUEST = 1;
    int filtercalled = 0;
    SharedPreferences myPrefs,myPrefs1,myPrefs2,myPrefs3,myPrefs4,myPrefs5,myPrefs6,myPrefs7,myPrefs8,myPrefs9,myPrefs10,doubt,login;
    // URL to get contacts JSON
    private static String url = "http://www.ezyschooling.com/top-nursery-schools-in-delhi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_browse1);
     ...
     //   setSupportActionBar(toolbar);
        ...
        myPrefs10 = this.getSharedPreferences("Type",MODE_PRIVATE);
         doubt = this.getSharedPreferences("Doubt",MODE_PRIVATE);
...
Toast.makeText(getBaseContext(),"Login To Proceed",Toast.LENGTH_LONG).show();
        ...
        Button viewForm = (Button) findViewById(R.id.ButtonViewForm);
        ...
        viewFilter.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                SharedPreferences.Editor prefsEditor = doubt.edit();
                prefsEditor.putString("sb1_f","go1");
                prefsEditor.commit();
        ...
        viewSort.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferences.Editor prefsEditor = doubt.edit();
                prefsEditor.putString("sb1_s","go2");
                prefsEditor.commit();
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SchoolBrowse1.this);
                    ...
                    for (int i = 0; i < jarray.length(); i++) {
                      ...
                      //  String Studentteacherratio = c.getString("Studentteacherratio");
                       ...
                       String Logo = null;
                        ...
                        SchoolProfile schoolProfile123 = new SchoolProfile(schoolid,Name,Fees,Description,Schooltimings,Location,Popularity,
                                Price,Daysleft, milestone_1 ,milestone_2 ,milestone_3,
        ...
        protected void onPostExecute(Void result) {
            ...
            if (go3 == 3) {
                Collections.sort(add_to_listview, new Comparator<SchoolProfile>() {
                    public int compare(SchoolProfile obj1, SchoolProfile obj2) {
                        ...
                        if (a > b) return -1;
                        return 0;
                        //Toast.makeText(getBaseContext(),"Sort used",Toast.LENGTH_LONG).show();
                ...
                adapter = new ListViewAdapter(SchoolBrowse1.this, add_to_listview);
            ...
            if (arrayList_values_counter.size()==0 || nofilter==1){
               ...
               // Toast.makeText(getBaseContext(),"yes ho rha h"+ add_to_listview.size()+ "  "+arrayList_counter.size(),Toast.LENGTH_LONG).show();
                for (int j =0; j< arrayList_counter.size();j++) {
                    ...
                    if (cur1.isAccomodation_show()){
                        values++;
                       // Toast.makeText(getBaseContext(),"2vyes ho rha h"+ values,Toast.LENGTH_SHORT).show();
                    }
                ...
                //  notifyAll();
                adp1 = new ListViewAdapter(SchoolBrowse1.this, add_to_listview);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (status.equals("true")){
            ...
            getMenuInflater().inflate(R.menu.settings_for_browse1, menu);
        }

        else{
            getMenuInflater().inflate(R.menu.settings_for_browse12, menu);
        }
        return true;
    }
    ...
    public void showSimpleDialog1() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(SchoolBrowse1.this);
