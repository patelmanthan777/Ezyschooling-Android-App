...
public class Fatherphoto extends AppCompatActivity implements View.OnClickListener{
    private TextView messageText;int go =0,go1=0;
    private Button uploadButton, btnselectpic,next;
      private Bitmap bitmap;SharedPreferences login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fatherphoto);
        myPrefs = this.getSharedPreferences("CAF",MODE_PRIVATE);
        uploadButton = (Button)findViewById(R.id.uploadButton); requestStoragePermission();
        btnselectpic = (Button)findViewById(R.id.button_selectpic);
        messageText  = (TextView)findViewById(R.id.messageText);  login = this.getSharedPreferences("Login_sp",MODE_PRIVATE);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.uploadButton:
                ...
                prefsEditor.putString("FatherPhoto",encodedImage);
                prefsEditor.commit();go1=1;
                break;
            case R.id.next :
                if (go==1){
                    if (go1==1) {
                        startActivity(new Intent(getBaseContext(), Motherphoto.class));
                    }
    ...
    public void showSimpleDialog() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(Fatherphoto.this);
